...
let package = Package(
    ...
    targets: [
        Target(name: "DemoConfiguration", dependencies: []),
        Target(name: "DemoAppServer", dependencies: ["DemoConfiguration"])
    ],
    dependencies: [
        ...
        .Package(url: "https://github.com/RuntimeTools/SwiftMetrics.git", versions: Version(0,0,1)..<Version(0,0,13)),
