...
let package = Package(
    ...
    targets: [
        ...
        Target(name: "DemoAppServer", dependencies: ["Configuration"])
    ],
    dependencies: [
        ...
        //.Package(url: "https://gitlab-polyglot.hursley.ibm.com/runtimetools/swiftmetrics-dash.git", majorVersion: 0),
